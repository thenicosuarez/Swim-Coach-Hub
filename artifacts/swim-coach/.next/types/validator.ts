...
// Validate ../../app/api/webhooks/calendly/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/webhooks/calendly">> = Specific
  const handler = {} as typeof import("../../app/api/webhooks/calendly/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../app/api/yoga-inquiry/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/yoga-inquiry">> = Specific
  const handler = {} as typeof import("../../app/api/yoga-inquiry/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
